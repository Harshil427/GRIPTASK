      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 " >
            <p>
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reprehenderit aliquam voluptatibus voluptas officiis aspernatur similique nesciunt nemo dignissimos, beatae magnam, illum libero accusamus animi laudantium unde? Fugit expedita nostrum laboriosam adipisci velit recusandae voluptate, deleniti perferendis, non consequatur minus inventore possimus saepe tempore, hic maiores commodi aspernatur? Error sed nesciunt sunt ab? Consectetur earum ullam, facilis officia amet assumenda distinctio blanditiis laborum adipisci molestiae, totam reprehenderit hic placeat nam nisi pariatur qui! Quo facilis et soluta necessitatibus minus nobis qui explicabo? Illo voluptatem ab dolore a reprehenderit. Ea nobis, laborum ad accusantium maiores modi perferendis rerum dicta voluptates, quia necessitatibus!
            </p>
            <div class="container col my-5">
                   <a href=""><button class="btn btn-primary" type="button" >Learn More</button></a>
                </div>
          </div>
        </div>
